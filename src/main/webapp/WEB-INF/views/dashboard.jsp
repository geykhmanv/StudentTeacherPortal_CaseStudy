...
<title>QuickPortal - Dashboard</title>
			...
			<div class="row">
				...
				<div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0"
					...
					<div class="icon-box">
						...
						<h4>
							<a href="/manage-faculty">Manage Faculty</a>
						</h4>
						<p>Access and maintain faculty records</p>
					</div>
				</div>
				<div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0"
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="#">Graphic Design</a></li>
				...
				<div class="col-lg-3 col-md-6 footer-contact">
					<h4>Contact Us</h4>
					<p>
						1111 First Street <br> Nowhere, NJ 535022<br> United
						States <br>
						<br> <strong>Phone:</strong> +1 5589 55488 55<br> <strong>Email:</strong>
						admin@bluebadgers.com<br>
					</p>
